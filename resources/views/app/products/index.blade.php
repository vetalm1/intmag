        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th>@lang('crud.products.inputs.cateory_id')</th>
                            <th>@lang('crud.products.inputs.name')</th>
                            <th>@lang('crud.products.inputs.slug')</th>
                            <th>@lang('crud.products.inputs.description')</th>
                            <th>@lang('crud.products.inputs.price')</th>
                            <th>@lang('crud.products.inputs.size')</th>
